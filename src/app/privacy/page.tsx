...
const sections = [
  ...
  { h: "How we use information", p: "We use your information to manage your membership, process registrations and payments, send communications you've requested, operate the business directory, and improve our services." },
...
export default function PrivacyPage() {
  return (
    <>
      <PageHero eyebrow="Legal" title="Privacy Policy" hue={170} breadcrumb={[{ label: "Home", href: "/" }, { label: "Privacy" }]} />
      <section className="py-16">
        <Container className="max-w-3xl">
          <p className="rounded-xl border border-line bg-brand-50/60 p-4 text-sm text-muted">
            This is a working draft to be reviewed and finalized by counsel before launch.
          </p>
          <div className="mt-8 space-y-8">
            {sections.map((s) => (
              <div key={s.h}>
                <h2 className="font-display text-xl font-semibold text-brand-900">{s.h}</h2>
