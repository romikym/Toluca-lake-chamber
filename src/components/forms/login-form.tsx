  ...
  return (
    <form action={formAction} className="mt-7 space-y-4">
      ...
      <label className="block">
        ...
        <input name="email" type="email" required autoComplete="email" className="h-11 w-full rounded-xl border border-line bg-canvas px-4 text-sm outline-none focus:border-brand-500" placeholder="you@email.com" />
      </label>
      <label className="block">
